          ...
          <div className="flex justify-end">
            ...
            >
              ...
              >
                <path
                  fillRule="evenodd"
                  d="M4.293 4.293a1 1 0 011.414 0L10 8.586l4.293-4.293a1 1 0 111.414 1.414L11.414 10l4.293 4.293a1 1 0 01-1.414 1.414L10 11.414l-4.293 4.293al 1 0 01-1.414-1.414L8.586 10 4.293 5.707a1 1 010-1.414z"
                  clipRule="evenodd"
                />
              </svg>
            </button>
          ...
          <div className="max-w-sm mx-auto py-3 space-y-3 text-center">
            ...
            >
              <div className="relative mt-3">
                <input
                  type="number"
                  className="w-full pl-5 pr-3 py-2 text-gray-500 bg-transparent outline-none border focus"
                  placeholder="Id"
