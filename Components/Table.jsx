...
function Table({setCreateShipmentModel, allShipmentsData}) {
      ...
      <div className='items-start justify-between md:flex'>
        <div className='max-w-lg'>
          ...
          <p className='text-gray-600 mt-2'>
            Lorem ipsum dolor sit amet consectetur adipisicing elit. Distinctio sunt impedit numquam quidem ad inventore facere non ratione soluta consequatur repellat voluptas consequuntur a, dolor deserunt dolores quasi dolorum totam.
          </p>
        </div>
